...
function PrivateRoute({ children, roles }) {
  ...
  if (profile?.role === 'parent' && !roles?.includes('parent')) return <Navigate to="/genitore" replace />
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/genitore" element={<PrivateRoute roles={['parent']}><ParentLayout /></PrivateRoute>}>
