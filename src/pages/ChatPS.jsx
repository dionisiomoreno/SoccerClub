...
const CHAT_DEFS = [
  { nome: '⚽ Prima Squadra', colore: '#1ab394' },
  { nome: '🌐 Generale',      colore: '#6c757d' },
]
...
export default function ChatPS() {
  ...
  async function sendMessage() {
    ...
    setSending(true)
    await supabase.from('messages').insert([{ chat_id: activeChat.id, sender_id: profile.id, contenuto: text.trim() }])
    setText('')
    setSending(false)
  }
